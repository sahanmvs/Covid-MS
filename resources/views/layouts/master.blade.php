...
<body id="page-top">
     ...
     <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('adduser') }}">Add</a>
                         <a class="collapse-item" href="{{ url('viewusers') }}">Manage</a>
                    </div>
                </div>
            </li>
    ...
    <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('addphlebotomist') }}">Add</a>
                         <a class="collapse-item" href="{{url('viewphlebotomists')}}">Manage</a>
                    </div>
                </div>
            </li>
     ...
     <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('newtests') }}">New</a>
                        <a class="collapse-item" href="{{ url('assignedtests') }}">Assigned</a>
                        <a class="collapse-item" href="{{ url('otwsamples') }}">On the Way for<br /> Sample Collection</a>
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item d-flex align-items-center" href="">
                ...
                <div>
                    ...
                    <span class="font-weight-bold">A new test received #</span>
                </div>
            </a>
